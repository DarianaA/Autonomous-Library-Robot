...
YCB_LABELS_FULL = [
            ...
            'ycb_070-a_colored_wood_blocks', 'oldman', 'ycb_054_softball',
...
def detect(msg):
    ...
    Returns:
        detect_objects {DetectObjectsResponse} -- full_pcl, object_clouds, scores, labels_text
    """
    pclmsg = rospy.wait_for_message('/xtion/depth_registered/points', PointCloud2)

    frame, pcl, boxes, clouds, scores, labels, labels_text, masks = \
        mask_rcnn.detect(pclmsg, confidence=0.7, mask_confidence=0.5)
