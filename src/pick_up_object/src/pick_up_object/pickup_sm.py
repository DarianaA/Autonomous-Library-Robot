...
from pick_up_object.states import GenerateGrasps, Pickup, Recovery, DropOff, DetectObjects, Navigation
...
if __name__ == '__main__':
    ...
    with sm:
        ...
        smach.StateMachine.add('Dropoff', DropOff(arm_torso_controller),
                                 transitions={
                                     'succeeded': 'end',
                                     'failed': 'end'},
                                 remapping={})
